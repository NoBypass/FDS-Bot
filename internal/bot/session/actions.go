...
func (c *FDSConnection) Login(pwd string) (*models.LoginResponse, error) {
	req, err := c.newRequest(http.MethodPost, "/discord/bot-login", &models.LoginRequest{Pwd: pwd}, nil)
	if err != nil {
		return nil, err
	}
